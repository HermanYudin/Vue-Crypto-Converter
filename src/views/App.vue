<template>
  <div id="app">
    ...
    <AppInput v-bind:changeAmount="changeAmount" v-bind:covert="convert" />
    ...
    <div class="selectors">
      <div>
        ...
        <InputSelector v-bind:setCrypto="setCryptoFirst" />
      </div>
      <p class="convert-to">TO</p>
      <div>
        <h2 class="convert-header">Second convert value</h2>
        <InputSelector v-bind:setCrypto="setCryptoSecond" />
      </div>
    </div>
  </div>
</template>
